<template>
	<div class="actions-wrapper">
		<template
			v-if="layoutMode === 'side' || (layoutMode === 'top' && isDesktop)"
		>
			<span
			...
			<span class="action welcome">Welcome，{{ username }}</span>
		</template>
		<template v-else>
				...
				<a-menu slot="overlay" @click="handleClick" class="user-menu">
					...
					<a-menu-item key="modifyPassword">
						<a href="javascript:;">
							...
							/>
							<span style="vertical-align: middle">Password Change</span>
						</a>
					</a-menu-item>
